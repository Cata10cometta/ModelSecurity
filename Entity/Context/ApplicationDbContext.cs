...
namespace Entity.Context
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<RolFormPermission> FormPermissions { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RolFormPermission>()
                .HasKey(rfp => new { rfp.RolId, rfp.FormId, rfp.PermissionId }); // Clave compuesta
            ...
            modelBuilder.Entity<FormModule>()
                .HasKey(fm => new { fm.FormId, fm.ModuleId }); // Clave compuesta
            ...
            // Configuración de las relaciones referenciales
            //User 
